 ...
 * available shapes include rectangles, rounded rectangles, ellipses, regular
 * polygons, and regular stars. The dimensions of the requested shapes are
 * defined by the specified <code>VertexSizeFunction</code> and
 * <code>VertexAspectRatioFunction</code> implementations: the width of the
 * bounding box of the shape is given by the vertex size, and the height is
 * given by the size multiplied by the vertex's aspect ratio.
 * 
...
public class VertexShapeFactory<V> {
	...
	/**
	 * Creates a <code>VertexShapeFactory</code> with a constant size of 10 and
	 * a constant aspect ratio of 1.
	 */
	...
	/**
	 * Returns a <code>Ellipse2D</code> whose width and height are defined by
	 * this instance's size and aspect ratio functions for this vertex.
	 */
	...
	/**
	 * Returns a <code>RoundRectangle2D</code> whose width and height are
	 * defined by this instance's size and aspect ratio functions for this
	 * vertex. The arc size is set to be half the minimum of the height and
	 * width of the frame.
	 */
	 ...
	 * 
	 * @param num_sides
	 *            the number of sides of the polygon; must be >= 3.
	 */
	 ...
	 * whose bounding box's width and height are defined by this instance's size
